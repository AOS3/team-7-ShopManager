...
import com.lion.team7_shopping_mall.databinding.FragmentModifyOuterBinding
...
class ModifyOuterFragment(val mainFragment: ModifyFragment) : Fragment() {
    lateinit var fragmentModifyOuterBinding: FragmentModifyOuterBinding
    ...
    override fun onCreateView(
        ...
        fragmentModifyOuterBinding = FragmentModifyOuterBinding.inflate(inflater)
        ...
        return fragmentModifyOuterBinding.root
    }
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    when (clothesViewModel.clothesTypeByCategory) {
                        ClothesTypeByCategoryName.COAT.str -> toggleGroupCategory.check(R.id.buttonCoat)
                        ClothesTypeByCategoryName.LONG_PADDING.str -> toggleGroupCategory.check(R.id.buttonLongPadding)
                        ClothesTypeByCategoryName.SHORT_PADDING.str -> toggleGroupCategory.check(R.id.buttonShortPadding)
                    }
...
//                                    )
                                    ...
                                    Glide.with(mainActivity)
                                        ...
                                        .into(fragmentModifyOuterBinding.imageViewSetImage)
                                }
                            })
...
//                        Log.d("test", "uri is null")
    ...
    fun initializeSelectedColors(list: List<String>) {
        ...
        // RecyclerView 갱신
        fragmentModifyOuterBinding.recyclerViewColorSelector.adapter?.notifyDataSetChanged()
    }
    ...
    private fun setImageBitmap(bitmap: Bitmap) {
        fragmentModifyOuterBinding.imageViewSetImage.setImageBitmap(bitmap)
        saveInTemp()
    }
