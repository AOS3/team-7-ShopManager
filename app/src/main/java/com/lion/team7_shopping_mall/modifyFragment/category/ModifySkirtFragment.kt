...
import com.lion.team7_shopping_mall.databinding.FragmentModifySkirtBinding
import com.lion.team7_shopping_mall.repository.ClothesInOutHistoryRepository


class ModifySkirtFragment(val mainFragment: ModifyFragment) : Fragment() {
    lateinit var fragmentModifySkirtBinding: FragmentModifySkirtBinding
    ...
    override fun onCreateView(
        ...
        fragmentModifySkirtBinding = FragmentModifySkirtBinding.inflate(inflater)
        ...
        return fragmentModifySkirtBinding.root
    }
    ...
    private fun setImage() {
        fragmentModifySkirtBinding.apply {
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    when (clothesViewModel.clothesTypeByCategory) {
                        ClothesTypeByCategoryName.LONG_SKIRT.str -> toggleGroupCategory.check(R.id.buttonLongSkirt)
                        ClothesTypeByCategoryName.MIDI_SKIRT.str -> toggleGroupCategory.check(R.id.buttonMidiSkirt)
                        ClothesTypeByCategoryName.MINI_SKIRT.str -> toggleGroupCategory.check(R.id.buttonMiniSkirt)
                    }
...
//                                    )
                                    ...
                                    Glide.with(mainActivity)
                                        ...
                                        .into(fragmentModifySkirtBinding.imageViewSetImage)
                                }
                            })
...
//                        Log.d("test", "uri is null")
    ...
    fun initializeSelectedColors(list: List<String>) {
        ...
        // RecyclerView 갱신
        fragmentModifySkirtBinding.recyclerViewColorSelector.adapter?.notifyDataSetChanged()
    }
    ...
    private fun setImageBitmap(bitmap: Bitmap) {
        fragmentModifySkirtBinding.imageViewSetImage.setImageBitmap(bitmap)
        saveInTemp()
    }
