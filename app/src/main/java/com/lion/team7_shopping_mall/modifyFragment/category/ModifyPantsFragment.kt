...
class ModifyPantsFragment(val mainFragment: ModifyFragment) : Fragment() {
    lateinit var fragmentModifyPantsBinding: FragmentModifyPantsBinding
    ...
    override fun onCreateView(
        ...
        fragmentModifyPantsBinding = FragmentModifyPantsBinding.inflate(inflater)
        ...
        return fragmentModifyPantsBinding.root
    }
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    when (clothesViewModel.clothesTypeByCategory) {
                        ClothesTypeByCategoryName.JEANS.str -> toggleGroupCategory.check(R.id.buttonJeans)
                        ClothesTypeByCategoryName.COTTON_PANTS.str -> toggleGroupCategory.check(R.id.buttonCottonPants)
                        ClothesTypeByCategoryName.SHORT_PANTS.str -> toggleGroupCategory.check(R.id.buttonShortPants)
                    }
...
//                                    )
                                    ...
                                    Glide.with(mainActivity)
                                        ...
                                        .into(fragmentModifyPantsBinding.imageViewSetImage)
                                }
                            })
...
//                        Log.d("test", "uri is null")
    ...
    fun initializeSelectedColors(list: List<String>) {
        ...
        // RecyclerView 갱신
        fragmentModifyPantsBinding.recyclerViewColorSelector.adapter?.notifyDataSetChanged()
    }
    ...
    private fun setImageBitmap(bitmap: Bitmap) {
        fragmentModifyPantsBinding.imageViewSetImage.setImageBitmap(bitmap)
        saveInTemp()
    }
